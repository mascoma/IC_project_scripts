...
ICC_DS2_1 = read.delim("/Users/Xin/Desktop/IC_project/output/Jan222016/ICC_DS2_1_unmapped_taxa_graph.csv",stringsAsFactors = F, header = T, sep = ",")
ICC_DS2_2 = read.delim("/Users/Xin/Desktop/IC_project/output/Jan222016/ICC_DS2_2_unmapped_taxa_graph.csv",stringsAsFactors = F, header = T, sep = ",")
head(ICC_DS2_1)
head(ICC_DS2_2)
head(ICC)
Sample = "ICC_DS2_1"
...
ggsave("/Users/Xin/Desktop/IC_project/output/Jan222016/ICC_DS2_1_unmapped_taxa70.png", width = 25, height = 15)
...
ggplot(DS2_2_ICC, aes(x = reorder(taxa, Percent), y = Percent, fill =  Sample)) + 
  ...
  theme(axis.text.x = element_text(angle=75, hjust=1, size = 15),
        ...
        panel.grid.minor.y = element_blank(),
        panel.grid.major.x = element_line(colour="grey60", linetype="dashed")) + xlab("Taxa")  
ggsave("/Users/Xin/Desktop/IC_project/output/Jan222016/ICC_DS2_2_unmapped_taxa70.png", width = 25, height = 15)
